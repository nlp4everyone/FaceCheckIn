...
@face_management_router.post("/face_register")
async def face_register(face_id :str = Form(...),
    ...
    try:
        ...
        # Get landmarks
        face_landmark = detection[0].keypoints
        # Get faces aligned
        face_aligned = BasicAlignment.align_face_5points(image = image_numpy,
                                                         landmarks = face_landmark.model_dump())
        # Embedding
...
@face_management_router.post("/face_retrieve")
