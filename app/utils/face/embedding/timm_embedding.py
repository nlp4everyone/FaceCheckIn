...
HF_TIMM_MODELS = Literal["hf_hub:gaunernst/vit_small_patch8_gap_112.cosface_ms1mv3",
...
class TimmEmbedding(BaseEmbedding):
    def __init__(self,
                 model_name :HF_TIMM_MODELS = "hf_hub:gaunernst/vit_small_patch8_gap_112.cosface_ms1mv3",
        ...
        self._model = timm.create_model(model_name,
                                        pretrained = pretrained).eval().to(self._device)
