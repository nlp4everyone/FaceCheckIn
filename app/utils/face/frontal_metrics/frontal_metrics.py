...
class MediapipeMetric:
    ...
    def extract_facial_properties(detection :FaceDetection,
        ...
        image_points = np.array([tuple(image_points.nose),
                                 tuple(image_points.chin),
                                 tuple(image_points.right_eye),
                                 tuple(image_points.left_eye),
                                 tuple(image_points.right_mouth),
                                 tuple(image_points.left_mouth)
        ], dtype="double")
