...
class FivePointsLandmark(BaseModel):
    left_eye :List[Union[int,float]] = Field(min_length=2, max_length=2)
    right_eye :List[Union[int,float]] = Field(min_length=2, max_length=2)
    nose :List[Union[int,float]] = Field(min_length=2, max_length=2)
    left_mouth :List[Union[int,float]] = Field(min_length=2, max_length=2)
    right_mouth :List[Union[int,float]] = Field(min_length=2, max_length=2)
